            ...
            <div className='flex flex-row items-center justify-between p-10 w-full h-full'>
                <div className='flex flex-col h-full justify-evenly grow'>
                    <div className='flex justify-center items-center'>
                        {loading ? <div className='h-24 w-24 flex items-center justify-center'> <PulseLoader loading={loading} color={'#000000'} size={10} aria-label="Loading Spinner" data-testid="loader" /> </div> : avatarImg.length > 0 ? <Image src={`/${avatarImg}.svg`} alt='profileImage' width={100} height={100}/> : user[0].profile_image ? <Image src={`${user[0].profile_image}`} width={100} height={100} alt='profileImage' className='mb-4' /> : <Image src={avatarImg} width={100} height={100} alt='profileImage' className='mb-4' />}
                    </div>
