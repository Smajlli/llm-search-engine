        ...
        return <div className='flex flex-col w-full sm:w-3/4 xl:w-1/3 h-96 bg-white boder-solid border-2 rounded-lg absolute z-20'>
            ...
            <div className='flex flex-row items-center justify-between p-10 w-full h-full'>
                <div className='flex flex-col h-full justify-evenly grow'>
                    ...
                    <button onClick={handleNewAvatar} className='text-xs sm:text-md p-2 hover:cursor-pointer hover:bg-slate-200 duration-200 border rounded-xl border-none bg-gradient-to-r from-slate-100'>Generate random avatar</button>
                    <button onClick={handleSaveAvatar} className='text-xs sm:text-md p-2 hover:cursor-pointer hover:bg-slate-200 duration-200 border rounded-xl border-none bg-gradient-to-r from-slate-100'>Set as avatar</button>
                </div>
